function G=config_run_behaviorStudy(G)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%  %{
%configuration for all available person days
G.PS_LIST= {
    {'p01'},(cellstr(strcat('s',num2str((1:1)','%02d'))))';
%     {'p12'},(cellstr(strcat('s',num2str((1:8)','%02d'))))';
...
% %     {'p16'},(cellstr(strcat('s',num2str((1:1)','%02d'))))';
%     {'p17'},(cellstr(strcat('s',num2str((1:8)','%02d'))))';
%     {'p18'},(cellstr(strcat('s',num2str((11:19)','%02d'))))';
%     {'p19'},(cellstr(strcat('s',num2str((1:9)','%02d'))))';
% % %     {'p19'},(cellstr(strcat('s',num2str((8:9)','%02d'))))';
%     {'p20'},(cellstr(strcat('s',num2str((1:9)','%02d'))))';
% % %     {'p20'},(cellstr(strcat('s',num2str((8:9)','%02d'))))';
%     {'p21'},(cellstr(strcat('s',num2str((1:7)','%02d'))))';
%    {'p22'},(cellstr(strcat('s',num2str((1:9)','%02d'))))';
%    {'p24'},(cellstr(strcat('s',num2str((1:8)','%02d'))))';
% % %
%     {'p25'},(cellstr(strcat('s',num2str((1:8)','%02d'))))';
% %     {'p25'},(cellstr(strcat('s',num2str((1:1)','%02d'))))';
...
% %     {'p32'},(cellstr(strcat('s',num2str((1:1)','%02d'))))';
%    {'p33'},(cellstr(strcat('s',num2str((1:8)','%02d'))))';
% %2     {'p33'},(cellstr(strcat('s',num2str((6:8)','%02d'))))';
%    {'p34'},(cellstr(strcat('s',num2str((1:8)','%02d'))))';
% %     {'p34'},(cellstr(strcat('s',num2str((1:3)','%02d'))))';
%    {'p35'},(cellstr(strcat('s',num2str((1:10)','%02d'))))';
% %     {'p35'},(cellstr(strcat('s',num2str((11:11)','%02d'))))';
% %
%     {'p36'},(cellstr(strcat('s',num2str((1:11)','%02d'))))';
% %      {'p36'},(cellstr(strcat('s',num2str((9:11)','%02d'))))';
%     {'p37'},(cellstr(strcat('s',num2str((1:9)','%02d'))))';
% %      {'p37'},(cellstr(strcat('s',num2str((9:9)','%02d'))))';
% %     {'p38'},(cellstr(strcat('s',num2str((1:3)','%02d'))))';
%     {'p39'},(cellstr(strcat('s',num2str((1:9)','%02d'))))';
% %     {'p39'},(cellstr(strcat('s',num2str((1:1)','%02d'))))';
% %     {'p39'},(cellstr(strcat('s',num2str((9:9)','%02d'))))';
%     {'p40'},(cellstr(strcat('s',num2str((1:10)','%02d'))))';
% %     {'p40'},(cellstr(strcat('s',num2str((1:1)','%02d'))))';
% %     {'p40'},(cellstr(strcat('s',num2str((9:10)','%02d'))))';
%    {'p41'},(cellstr(strcat('s',num2str((1:11)','%02d'))))';
% %     {'p41'},(cellstr(strcat('s',num2str((1:2)','%02d'))))';
% %     {'p41'},(cellstr(strcat('s',num2str((10:11)','%02d'))))';
%     {'p42'},(cellstr(strcat('s',num2str((1:8)','%02d'))))';
% %     {'p42'},(cellstr(strcat('s',num2str((8:8)','%02d'))))';
%    {'p43'},(cellstr(strcat('s',num2str((1:9)','%02d'))))';
% %     {'p43'},(cellstr(strcat('s',num2str((8:9)','%02d'))))';
%    {'p44'},(cellstr(strcat('s',num2str((1:7)','%02d'))))';
%     {'p44'},(cellstr(strcat('s',num2str((8:8)','%02d'))))';
};

%}

% %configuration for listed seven calendar dates
% G.PS_LIST= {
...
%configuration for phone accel processing
% %{
% G.PS_LIST= {
%     {'p12'},(cellstr(strcat('s',num2str((5:6)','%02d'))))';
%     {'p13'},(cellstr(strcat('s',num2str((2:8)','%02d'))))';
%     {'p14'},(cellstr(strcat('s',num2str((3:8)','%02d'))))';
% % %     {'p14'},(cellstr(strcat('s',num2str((7:10)','%02d'))))';
%     {'p15'},(cellstr(strcat('s',num2str((1:7)','%02d'))))';
%     {'p16'},(cellstr(strcat('s',num2str((5:8)','%02d'))))';
%     {'p17'},(cellstr(strcat('s',num2str((1:8)','%02d'))))';
%     {'p18'},(cellstr(strcat('s',num2str((12:17)','%02d'))))';
%     {'p19'},(cellstr(strcat('s',num2str((1:5)','%02d'))))';
%     {'p20'},(cellstr(strcat('s',num2str((1:7)','%02d'))))';
%     {'p21'},(cellstr(strcat('s',num2str((1:4)','%02d'))))';
% %     {'p21'},(cellstr(strcat('s',num2str((1:4)','%02d'))))';
%     {'p22'},(cellstr(strcat('s',num2str((1:6)','%02d'))))';
%     {'p24'},(cellstr(strcat('s',num2str((1:6)','%02d'))))';
%     {'p25'},(cellstr(strcat('s',num2str((2:8)','%02d'))))';
%     {'p26'},(cellstr(strcat('s',num2str((1:8)','%02d'))))';
%     {'p27'},(cellstr(strcat('s',num2str((1:8)','%02d'))))';
%     {'p28'},(cellstr(strcat('s',num2str((1:2)','%02d'))))';
%     {'p28'},(cellstr(strcat('s',num2str((4:7)','%02d'))))';
%     {'p29'},(cellstr(strcat('s',num2str((1:8)','%02d'))))';
%     {'p30'},(cellstr(strcat('s',num2str((1:6)','%02d'))))';
%     {'p31'},(cellstr(strcat('s',num2str((1:7)','%02d'))))';
%     {'p32'},(cellstr(strcat('s',num2str((2:8)','%02d'))))';
%     {'p33'},(cellstr(strcat('s',num2str((1:5)','%02d'))))';
%     {'p34'},(cellstr(strcat('s',num2str((4:11)','%02d'))))';
%     {'p35'},(cellstr(strcat('s',num2str((1:10)','%02d'))))';
% %
%     {'p36'},(cellstr(strcat('s',num2str((1:7)','%02d'))))';
...
%     {'p42'},(cellstr(strcat('s',num2str((1:7)','%02d'))))';
%     {'p43'},(cellstr(strcat('s',num2str((1:7)','%02d'))))';
%     {'p44'},(cellstr(strcat('s',num2str((1:1)','%02d'))))';
%     {'p44'},(cellstr(strcat('s',num2str((3:4)','%02d'))))';
%     {'p44'},(cellstr(strcat('s',num2str((6:7)','%02d'))))';
% };
%}
%% Formatted Raw
G.RUN.FRMTRAW.SENSORLIST_TOS=[G.SENSOR.R_RIPID,G.SENSOR.R_ECGID,G.SENSOR.R_GSRID,G.SENSOR.R_ACLXID, G.SENSOR.R_ACLYID, G.SENSOR.R_ACLZID,...
    ...
    G.SENSOR.WR9_ACLXID,G.SENSOR.WR9_ACLYID,G.SENSOR.WR9_ACLZID,G.SENSOR.WR9_GYRXID,G.SENSOR.WR9_GYRYID,G.SENSOR.WR9_GYRZID];
...
G.RUN.FRMTRAW.SENSORLIST_PHONE=[G.SENSOR.P_ACLXID, G.SENSOR.P_ACLYID, G.SENSOR.P_ACLZID];
