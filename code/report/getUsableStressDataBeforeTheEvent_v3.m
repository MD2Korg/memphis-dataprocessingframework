...
function [badData intermittentBad goodData activity usableForStress]=getUsableStressDataBeforeTheEvent_v3(participant,day,intermittantLooseEpisodes,goodEpisodes,activityEpisodes,activeInProtocol,timestamp,offset)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
intermittentBad=intermittentBad/60;
end
